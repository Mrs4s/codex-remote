    ...
    <SettingsSection
      ...
      subtitle={
        isMobileSimplified
          ...
          : "Configure how codex-remote exposes TCP backend access for mobile and remote clients. Desktop usage remains local unless you explicitly connect through remote mode."
      }
    >
      ...
      <>
        ...
        {!isMobileSimplified && (
          <SettingsToggleRow
            ...
            subtitle="If disabled, codex-remote stops managed TCP daemon processes before exit."
          >
            <SettingsToggleSwitch
        ...
        <div className="settings-field">
          ...
          <div className="settings-help">
            {isMobileSimplified
              ? "Use the Tailscale host from your desktop codex-remote app (Server section), for example `macbook.your-tailnet.ts.net:4732`."
      ...
      <div className="settings-help">
        {isMobileSimplified
          ? "Use your own infrastructure only. On iOS, get the Tailscale hostname and token from your desktop codex-remote setup."
          : "Mobile access should stay scoped to your own infrastructure (tailnet). codex-remote does not provide hosted backend services."}
      </div>
      {addRemoteOpen && (
        <ModalShell
